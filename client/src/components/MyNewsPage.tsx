                ...
                <div className="modal modal-open">
                    <div className="modal-box">
                        ...
                        <div className="modal-action">
                            <button className="btn rounded-lg bg-[#B81C21] hover:bg-red-800 text-white h-8 font-bold" onClick={handleDelete}>
                                Delete
                            </button>
                            <button
                ...
                <div className="container mx-auto px-32 py-16">
                    ...
                    {noResults ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10">
                            {newsList.map((news) => (
                                <MyNewsCard key={news.news_id} {...news} onDelete={() => confirmDelete(news.news_id)} />
                            ))}
                        </div>
                    )}
                </div>
...
//                             </button>
//                             <HashLink to="/dashboard#bookmarks" scroll={(el) => el.scrollIntoView({ behavior: 'smooth', block: 'start' })}>
//                                 <a className="btn bg-[#B81C21] hover:bg-red-800 rounded-lg text-white h-12 font-semibold" >
//                                     Bookmarks
//                                 </a>
//                             </HashLink>
//                             <button onClick={() => navigate('/')} className="btn btn-secondary rounded-lg font-bold">
