...
// import { showToast } from '../utils/toast';
// import { useCloudinaryUpload } from '../utils/upload';
// import { fetchTags } from '../services/tagService';  // Import your tag fetching function
...
//     const [thumbnail, setThumbnail] = useState<File | null>(null);
//     const [thumbnailUrl, setThumbnailUrl] = useState<string>('');
//     const [selectedTags, setSelectedTags] = useState<number[]>([]); // Store tag_ids
//     const [tags, setTags] = useState<any[]>([]); // For holding the fetched tags
...
//             navigate('/');
//         }
//         // Fetch tags from backend (using getTags or a similar function)
//         const getTags = async () => {
//             try {
//                 const response = await fetchTags();
//                 setTags(response); // Assuming response is an array of tags with tag_id and tag properties
//             } catch (error) {
...
//     const visibleTags = filteredTags.slice(0, 12); // Show only the first 18 tags
...
//             selectedTags.forEach((tag_id) => formData.append('tags[]', String(tag_id)));
//             await createNews(formData);
//             setTitle('');
//             setContent('');
//             setThumbnail(null);
